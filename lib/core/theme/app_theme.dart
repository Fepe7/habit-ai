...
class AppTheme {
  ...
  // surfaces — escala "cielo" luminosa de DESIGN.md (regla del tinte navy: los
  // neutros SIEMPRE tiran a azul de marca, nunca a gris). Las cards blancas
  // siguen destacando como islas pero el campo respira en vez de apagarse.
  ...
  // textos — Ink: casi negro tintado a navy (nunca #000), Slate para secundario
